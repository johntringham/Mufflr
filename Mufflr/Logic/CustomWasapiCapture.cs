...
namespace NAudio.CoreAudioApi
{
    ...
    public class CustomWasapiCapture : IWaveIn
    {
        ...
        private readonly int audioBufferMicrosecondsLength;
        ...
        public CustomWasapiCapture(MMDevice captureDevice)
        ...
        public CustomWasapiCapture(MMDevice captureDevice, bool useEventSync)
        ...
        public CustomWasapiCapture(MMDevice captureDevice, bool useEventSync, int audioBufferMillisecondsLength)
        {
            syncContext = SynchronizationContext.Current;
            audioClient = captureDevice.AudioClient;
            ShareMode = AudioClientShareMode.Shared;
            isUsingEventSync = useEventSync;
            this.audioBufferMicrosecondsLength = audioBufferMillisecondsLength;
        ...
        private void InitializeCaptureDevice()
        {
            ...
            long requestedDuration = ReftimesPerMillisec * audioBufferMicrosecondsLength;
